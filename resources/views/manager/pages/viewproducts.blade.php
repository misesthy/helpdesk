...
<head>
  ...
  <title>View Products-Faveo Auto Update Script</title>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                ...
                <li class="nav-item">
                <a href="viewproducts.html" class="nav-link active">
                  <i class="nav-icon fas fa-angle-right"></i>
    ...
    <div class="content-wrapper" style="min-height: 652.2px;">
        <section class="content-header">
            <div class="alert alert-info">
                <h4>View Products</h4>
                <p>View existing products. If any product needs to be modified, click the product name. If any product needs to be deleted, check the product name and click the 'Submit' button.</p>
            </div>
        </section>
                    ...
                    <table class="custom_table table table-bordered table-striped table-hover dataTable" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
                        <thead>
                            <tr role="row">
                                ...
                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="SKU: activate to sort column ascending" style="width: 85px;">SKU</th>
                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Homepage: activate to sort column ascending" style="width: 163.4px;">Homepage</th>
                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Version: activate to sort column ascending" style="width: 125px;">Price</th>
                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Licenses: activate to sort column ascending" style="width: 135.4px;">Version</th>
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <th rowspan="1" colspan="1">Homepage</th>
