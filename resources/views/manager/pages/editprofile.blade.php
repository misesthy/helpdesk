...
<head>
  ...
  <title>Edit Profile-PHP Auto Update Script</title>
     ...
     <div class="content-wrapper" style="min-height: 603px;">
         <section class="content-header">
             <div class="alert alert-info">
                 <h4>My Profile</h4>
                 <p>Edit your profile. Update profile information and click the 'Submit' button.<br><br><b>Attention</b>: enter new password only if you want to change current password. Otherwise, leave password fields empty.</p>
             </div>
         </section>
                         ...
                         <div class="row">
                             <div class="col-md-6">
                                 <div class="form-group">
                                     ...
                                     (optional) 
                                     <input type="text" name="admin_fname" value="" class="form-control" placeholder="First Name (optional)">
                                 </div>
                             </div>
                             <div class="col-md-6">
                                 <div class="form-group">
                                     ...
                                     (optional) 
                                     <input type="text" name="admin_lname" value="" class="form-control" placeholder="Last Name (optional)">
                                 </div>
                             </div>
                         </div>
                         <div class="row">
                             <div class="col-md-6">
                                 <div class="form-group">
                                     ...
                                     <input type="text" name="admin_email_1" value="info@ladybirdwebhost.com" class="form-control" placeholder="Email address">
                                 </div>
                             </div>
                             <div class="col-md-6">
                                 <div class="form-group">
                                     <label>Email Address (Confirm)</label>
                                     <input type="text" name="admin_email_2" value="info@ladybirdwebhost.com" class="form-control" placeholder="New email address (confirm)">
                                 </div>
                             </div>
                         </div>
                         <div class="row">
                             <div class="col-md-6">
                                 <div class="form-group">
                                     ...
                                     (optional) 
                                     <input type="password" name="admin_password_1" class="form-control" placeholder="New password (optional)"></div>
                             </div>
                             <div class="col-md-6">
                                 <div class="form-group">
                                     <label>New Password 
                                     ...
                                     (optional) 
                                     <input type="password" name="admin_password_2" class="form-control" placeholder="New password (confirm) (optional)">
                                 </div>
                             </div>
                         </div>
                         <div class="row">
                             <div class="col-md-6">
                                 <div class="form-group">
                                     <label>Allowed Login IP(s)</label> 
                                     (optional) 
                                     <input type="text" name="admin_ip" value="" class="form-control" placeholder="Allowed Login IP(s) (optional)"></div>
                             </div>
                             <div class="col-md-6">
                                 <div class="form-group">
                                     <label>Additional Authentication Protection</label>
                                     <select name="admin_data_authenticity" class="form-control select2 select2-hidden-accessible" data-select2-id="1" tabindex="-1" aria-hidden="true">
