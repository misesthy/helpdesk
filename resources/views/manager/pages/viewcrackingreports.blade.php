...
<head>
  ...
  <title>View Cracking Reports-Faveo Auto Update Script</title>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                ...
                <li class="nav-item">
                <a href="viewcrackingreports.html" class="nav-link active">
                 <i class="nav-icon fas fa-angle-right"></i>
    ...
    <div class="content-wrapper" style="min-height: 652.2px;">
        <section class="content-header">
            <div class="alert alert-info">
                <h4>View Cracking Reports</h4>
                <p>View cracking reports. If any report needs to be deleted, check the report and click the 'Submit' button.<br><br><b>Attention</b>:  all failed updates are displayed in View Update Reports section; therefore, this section should always be empty. If you see any record here, most likely someone was sending invalid data to updates server. If automatic hosts banning is enabled, PHP Auto Update Script will ban attacker automatically. Otherwise, you should ban attacker's host manually.</p>
            </div>
        </section>
        ...
        <div class="box box-primary">
            <div class="row">
                ...
                <div class="box-header with-border">
                    <h3 class="box-title">View Cracking Reports</h3>
                </div>
                </div>
                ...
                <div class="input-group date">
                   <div class="input-group-prepend">
                      <span class="input-group-text" id="basic-addon1"> <i class="fa fa-calendar" style="color: #3c8dbc;"></i></span>
                    </div>
                  <input type="text" class="form-control pull-right" id="datepicker" placeholder="Date From.." >
                </div>
                    </div>
                    </div>
                    <div class="col-lg-2">
                ...
                <div class="input-group date">
                  ...
                  <input type="text" class="form-control pull-right" id="datepicker1" placeholder="Date To..">
                </div>
                    </div>
                </div>
                    ...
                    <table class="custom_table table table-bordered table-striped table-hover dataTable" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
                        <thead>
                            <tr role="row">
                                ...
                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="2" aria-label="Product: activate to sort column ascending" style="width: 130.6px;">Report</th>
                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="2" aria-label="Licenses: activate to sort column ascending" style="width: 135.4px;">Date</th>
                                 <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="2" aria-label="Licenses: activate to sort column ascending" style="width: 135.4px;">status</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr class="odd">
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <th rowspan="1" colspan="2">Report</th>
