...
<head>
  ...
  <title>Uninstall License-PHP Auto Update Script</title>
      ...
      <div class="content-wrapper" style="min-height: 603px;">
          <section class="content-header">
              <div class="alert alert-warning">
                  <h4>Uninstall License</h4>
                  <p>Uninstall your license, so you can re-install PHP Auto Update Script on another system.<br><br><b>Attention</b>: once you click the 'Submit' button, there will be no further confirmation and this installation will stop working immediately.</p>
              </div>
          </section>
          <section class="content">
              <div class="box box-primary">
                  <div class="box-header with-border">
                      <h3 class="box-title">Uninstall License</h3>
                  </div><form action="uninstall_license.php" method="post">
                  <div class="box-body">
                      <div class="row">
                          <div class="col-xs-12">
                              <div class="checkbox" style="padding: 7px;">
                                  <label>
                                      <input type="checkbox" name="uninstall_license" value="1" onclick="return confirm('Are you absolutely sure?');"> Check the box to confirm license Uninstall
                                  </label>
                              </div>
                          </div>
                      </div>
