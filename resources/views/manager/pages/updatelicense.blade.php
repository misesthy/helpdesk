...
<head>
  ...
  <title>Update License-PHP Auto Update Script</title>
      ...
      <div class="content-wrapper" style="min-height: 603px;">
          <section class="content-header">
              <div class="alert alert-warning">
                  ...
                  <p>Update your license if IP address of this installation was changed, so PHP Auto Update Script continues to work on new IP. Otherwise, next license verification will fail.<br><br><b>Attention</b>: once you click the 'Submit' button, there will be no further confirmation and license will be updated immediately.</p>
              </div>
          </section>
          <section class="content">
              <div class="box box-primary">
                  <div class="box-header with-border">
                      <h3 class="box-title">Update License</h3>
                  </div><form action="update_license.php" method="post">
                  <div class="box-body">
                      <div class="row">
                          <div class="col-xs-12">
                              <div class="checkbox" style="padding: 7px;">
                                  <label>
                                      <input type="checkbox" name="update_license" value="1" onclick="return confirm('Are you absolutely sure?');"> Check the box to confirm license update
                                  </label>
                              </div>
                          </div>
                      </div>
                  ...
                  <div class="box-footer">
                      <button class="btn btn-primary" name="submit_ok">Submit</button>
                  </div>
                  </form>
              </div>
          </section>
