...
<head>
  ...
  <title>Add New Banned Hosts-Faveo Auto Update SCript</title>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
         ...
         <li class="nav-item has-treeview">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="Banned.html" class="nav-link active">
                  <i class="nav-icon fas fa-angle-right"></i>
       ...
       <div class="content-wrapper" style="min-height: 603px;">
           <section class="content-header">
               <div class="alert alert-info">
                   <h4>Add New Banned Host</h4>
                   <p>Add new banned host to be blocked from using PHP Auto Update SCript. Enter IP address and click the 'Submit' button.</p>
               </div>
           </section>
           <section class="content">
               <div class="box box-primary">
                   <div class="box-header with-border">
                       <h3 class="box-title">Add New Banned Host</h3>
                   </div>
                   <form>
                       <div class="box-body">
                           <div class="row">
                               <div class="col-md-6">
                                   <div class="form-group">
                                       ...
                                       <input type="text" name="banned_host_ip" value="" class="form-control" placeholder="IP address">
                                   </div>
                               </div>
                               <div class="col-md-6">
                                   <div class="form-group">
                                       <label>Comments</label> (optional) <input type="text" name="banned_host_comments" value="" class="form-control" placeholder="Additional comments (optional)">
                                   </div>
                               </div>
                           </div>
                       </div>
