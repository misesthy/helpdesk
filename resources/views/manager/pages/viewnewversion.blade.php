...
<head>
  ...
  <title>View Versions-Faveo Auto Update Script</title>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="viewnewversion.html" class="nav-link active">
                 <i class="nav-icon fas fa-angle-right"></i>
    ...
    <div class="content-wrapper" style="min-height: 652.2px;">
        <section class="content-header">
            <div class="alert alert-info">
                <h4>View Versions</h4>
                <p>View existing versions. If any version needs to be modified, click the product version. If any version needs to be deleted, check the product version and click the 'Submit' button.</p>
            </div>
        </section>
        <section class="content">
        <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">View Versions</h3>
                </div>
            <div class="row">
            <div class="col-lg-12">
           ...
           <input type="text" class="form-control" placeholder="Search here.." aria-label="Input group example" aria-describedby="btnGroupAddon2">
                    ...
                    <table class="custom_table table table-bordered table-striped table-hover dataTable" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
                        <thead>
                            <tr role="row">
                                ...
                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="SKU: activate to sort column ascending" style="width: 85px;">Versions</th>
                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Homepage: activate to sort column ascending" style="width: 163.4px;">Latest Version</th>
                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Version: activate to sort column ascending" style="width: 125px;">Latest Version Date</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr class="odd">
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <th rowspan="1" colspan="1">Versions</th>
                                <th rowspan="1" colspan="1">Latest Version</th>
                                <th rowspan="1" colspan="1">Latest Version Date</th>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-9">
                  ...
                  <div class="pagination c" id="pagination">
