...
<head>
  ...
  <title>System Cleanup Settings-Faveo Auto Update Script</title>
         ...
         <li class="nav-item has-treeview">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="Systemcleanup.html" class="nav-link active">
                  <i class="nav-icon fas fa-angle-right"></i>
        ...
        <div class="content-wrapper" style="min-height: 728px;" data-select2-id="24">
            <section class="content-header">
                <div class="alert alert-info">
                    <h4>System Cleanup Settings</h4>
                    <p>Configure system cleanup settings. Automatic removal of old data can slightly reduce database usage and improve overall performance.</p>
                </div>
            </section>
            <section class="content" data-select2-id="23">
                <div class="box box-primary" data-select2-id="22">
                    <div class="box-header with-border">
                        <h3 class="box-title">System Cleanup Settings</h3>
                    </div>
                    <form action="settings_cleanup.php" method="post" data-select2-id="21">
                        <div class="box-body" data-select2-id="20">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Automatic System Cleanup</label>
                                        <select name="database_cleanup_enabled" class="form-control select2 select2-hidden-accessible" data-select2-id="1" tabindex="-1" aria-hidden="true">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Remove Versions Expired More Than...</label>
                                        <select name="database_cleanup_callbacks" class="form-control select2 select2-hidden-accessible" data-select2-id="4" tabindex="-1" aria-hidden="true">
                                            <option value="0">Disabled</option>
                                            ...
                                            <option value="365" selected="" data-select2-id="6">365 Days</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            <div class="row" data-select2-id="19">
                                <div class="col-md-6" data-select2-id="18">
                                    <div class="form-group" data-select2-id="17">
                                        <label>Remove Update Reports Older Than...</label>
                                        <select name="database_cleanup_reports_main" class="form-control select2 select2-hidden-accessible" data-select2-id="7" tabindex="-1" aria-hidden="true">
                                            <option value="0" data-select2-id="28">Disabled</option>
                                            <option value="1" data-select2-id="29">1 Day</option>
                                            <option value="7" data-select2-id="30">7 Days</option>
                                            <option value="14" data-select2-id="31">14 Days</option>
                                            <option value="30" data-select2-id="32">30 Days</option>
                                            <option value="60" data-select2-id="33">60 Days</option>
                                            <option value="90" data-select2-id="34">90 Days</option>
                                            <option value="180" data-select2-id="35">180 Days</option>
                                            <option value="365" selected="" data-select2-id="9">365 Days</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Remove System Reports Older Than...</label>
                                        <select name="database_cleanup_reports_system" class="form-control select2 select2-hidden-accessible" data-select2-id="10" tabindex="-1" aria-hidden="true">
                                            <option value="0">Disabled</option>
                                            <option value="1">1 Day</option>
                                            <option value="7">7 Days</option>
                                            <option value="14">14 Days</option>
                                            ...
                                            <option value="90">90 Days</option>
                                            <option value="180">180 Days</option>
                                            <option value="365" selected="" data-select2-id="12">365 Days</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Remove Obsolete Installation/Upgrade Files</label>
                                        <select name="database_cleanup_obsolete_installations" class="form-control select2 select2-hidden-accessible" data-select2-id="13" tabindex="-1" aria-hidden="true">
                                            <option value="0" selected="" data-select2-id="15">Disabled</option>
