...
<head>
  ...
  <title>View API Keys-Faveo Auto Update Script</title>
         ...
         <li class="nav-item has-treeview">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="viewapi.html" class="nav-link active">
                 <i class="nav-icon fas fa-angle-right"></i>
                  <p>View API Key</p>
                </a>
              </li>
       ...
       <div class="content-wrapper" style="min-height: 652.2px;">
        ...
        <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">View API Keys</h3>
                </div>
            <div class="row">
            <div class="col-lg-12">
                    ...
                    <table class="custom_table table table-bordered table-striped table-hover dataTable" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
                        <thead>
                            <tr role="row">
                                ...
                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Product: activate to sort column ascending" style="width: 130.6px;">API Secret</th>
                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="SKU: activate to sort column ascending" style="width: 112.2px;">IP Address</th>
                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Homepage: activate to sort column ascending" style="width: 163.4px;">Add/Edit Products</th>
                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Version: activate to sort column ascending" style="width: 125px;">Add/Edit Versions</th>
                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Status: activate to sort column ascending" style="width: 112.2px;">Search</th>
                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Status: activate to sort column ascending" style="width: 112.2px;">Status</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr class="odd">
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <th rowspan="1" colspan="1">API Secret</th>
                                <th rowspan="1" colspan="1">IP Address</th>
                                <th rowspan="1" colspan="1">Add/Edit Products</th>
                                <th rowspan="1" colspan="1">Add/Edit Versions</th>
                                <th rowspan="1" colspan="1">Search</th>
