...
<head>
  ...
  <title>Add New API Key-Faveo Auto Update Script</title>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
         ...
         <li class="nav-item has-treeview">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="Addapi.html" class="nav-link active">
                  <i class="nav-icon fas fa-angle-right"></i>
                  <p>Add New API Key</p>
                </a>
              </li>
                   ...
                   <form>
                       <div class="box-body">
                           <div class="row">
                               <div class="col-md-6">
                                   <div class="form-group">
                                       <label>API Secret (<a href="#" onclick="generateApiKey();return false;" style="color: #3c8dbc;">Generate</a>)</label>
                                       <input type="text" name="api_key_secret" value="" class="form-control" placeholder="Unique API secret" id="api_key">
                                   </div>
                               </div>
                               <div class="col-md-6">
                                   <div class="form-group">
                                       <label>API IP</label>
                                       <input type="text" name="api_key_ip" value="" class="form-control" placeholder="IP address to accept API requests from (optional)">
                                   </div>
                               </div>
                           </div>
                           <div class="row">
                               <div class="col-md-6">
                                   <div class="form-group">
                                       <label>Permissions to Add Products</label>
                                       <select name="api_key_products_add" class="form-control select2 select2-hidden-accessible" data-select2-id="1" tabindex="-1" aria-hidden="true">
                               ...
                               <div class="col-md-6">
                                   <div class="form-group">
                                       <label>Permissions to Edit Products</label>
                                       <select name="api_key_products_edit" class="form-control select2 select2-hidden-accessible" data-select2-id="4" tabindex="-1" aria-hidden="true">
                           ...
                           <div class="row">
                               <div class="col-md-6">
                                   <div class="form-group">
                                       <label>Permissions to Add Versions</label>
                                       <select name="api_key_versions_add" class="form-control select2 select2-hidden-accessible" data-select2-id="7" tabindex="-1" aria-hidden="true">
                                           <option value="1" data-select2-id="9">Active</option>
                                           <option value="0">Inactive</option>
                                       </select>
                                   </div>
                               </div>
                               <div class="col-md-6">
                                   <div class="form-group">
                                       <label>Permissions to Edit Versions</label>
                                       <select name="api_key_versions_edit" class="form-control select2 select2-hidden-accessible" data-select2-id="10" tabindex="-1" aria-hidden="true">
                                           <option value="1" data-select2-id="12">Active</option>
                                           <option value="0">Inactive</option>
                                       </select>
                                   </div>
                               </div>
                           ...
                           <div class="row">
                               ...
                               <div class="col-md-6">
                                   <div class="form-group">
                                       <label>Permissions to Use Search</label>
                                       <select name="api_key_search" class="form-control select2 select2-hidden-accessible" data-select2-id="22" tabindex="-1" aria-hidden="true">
                                           <option value="1" data-select2-id="24">Active</option>
                                           <option value="0">Inactive</option>
                                       </select>
                                   </div>
                               </div>
                               <div class="col-md-6">
                                   <div class="form-group">
                                       ...
                                       <select name="api_key_status" class="form-control select2 select2-hidden-accessible" data-select2-id="25" tabindex="-1" aria-hidden="true">
                                           <option value="1" data-select2-id="27">Active</option>
                                           <option value="0">Inactive</option>
                                       </select>
                                       </div>
                               </div>
