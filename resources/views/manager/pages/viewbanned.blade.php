...
<head>
  ...
  <title>View Banned Hosts-Faveo Auto Update Script</title>
         ...
         <li class="nav-item has-treeview">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="viewbanned.html" class="nav-link active">
                  <i class="nav-icon fas fa-angle-right"></i>
        ...
        <div class="box box-primary">
            <div class="row">
                ...
                <div class="box-header with-border">
                    <h3 class="box-title">View Banned Hosts</h3>
                </div>
                </div>
                    ...
                    <table class="custom_table table table-bordered table-striped table-hover dataTable" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
                        <thead>
                            <tr role="row">
                                ...
                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="2" aria-label="SKU: activate to sort column ascending" style="width: 112.2px;">IP Address</th>
                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="2" aria-label="Homepage: activate to sort column ascending" style="width: 163.4px;">Comments</th>
                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Version: activate to sort column ascending" style="width: 125px;">Date</th>
                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Licenses: activate to sort column ascending" style="width: 135.4px;">Blocks</th>
                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="2" aria-label="Installations: activate to sort column ascending" style="width: 183.4px;">Latest Blocks</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr class="odd">
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <th rowspan="1" colspan="2">IP Address</th>
                                <th rowspan="1" colspan="2">Comments</th>
                                <th rowspan="1" colspan="1">Date</th>
                                <th rowspan="1" colspan="1">Blocks</th>
                                <th rowspan="1" colspan="2">Latest Block</th>
                            </tr>
                        </tfoot>
                    </table>
                </div>
