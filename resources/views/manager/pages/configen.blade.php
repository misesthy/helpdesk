...
<head>
  ...
  <title>Configuration Generator-Faveo Auto Update Script</title>
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <div class="dropdown-divider"></div>
          <a hrefhttps://www.phpmillion.com/forums/ class="dropdown-item">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
         ...
         <li class="nav-item has-treeview">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="configen.html" class="nav-link active">
                   <i class="nav-icon fas fa-angle-right"></i>
        ...
        <div class="content-wrapper" style="min-height: 603px;">
            <section class="content-header">
                <div class="alert alert-info">
                    ...
                    <p>Automatically generate settings for aus_core_configuration.php file. Select product to be installed and/or updated, and click the 'Submit' button. Once configuration is generated, copy/paste its content to your aus_core_configuration.php file.</p>
                </div>
            </section>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="config_aus_connection_timeout" value="30" class="form-control" placeholder="Connection timeout (in seconds) after which connection will be dropped">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Delete Downloaded Archive After Extracting</label>
                                        <select name="config_aus_delete_extracted" class="form-control select2 select2-hidden-accessible" data-select2-id="4" tabindex="-1" aria-hidden="true">
