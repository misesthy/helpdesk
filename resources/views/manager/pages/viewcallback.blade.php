...
<head>
  ...
  <title>View Callbacks-Faveo Auto Update Script</title>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="viewcallback.html" class="nav-link active">
                 <i class="nav-icon fas fa-angle-right"></i>
                  <p>View Callbacks</p>
                </a>
              </li>
    ...
    <div class="content-wrapper" style="min-height: 652.2px;">
        <section class="content-header">
            <div class="alert alert-info">
                <h4>View Callbacks</h4>
                <p>View existing installation and/or upgrade callbacks. If any callback needs to be deleted, check the product name and click the 'Submit' button.</p>
            </div>
        </section>
        <section class="content">
        <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">View Callbacks</h3>
                </div>
            <div class="row">
            <div class="col-lg-12">
                    ...
                    <table class="custom_table table table-bordered table-striped table-hover dataTable" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info">
                        <thead>
                            <tr role="row">
                                ...
                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Homepage: activate to sort column ascending" style="width: 163.4px;">Callabacks</th>
                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Licenses: activate to sort column ascending" style="width: 135.4px;">Latest Callbacks</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr class="odd">
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <th rowspan="1" colspan="1">Callbacks</th>
                                <th rowspan="1" colspan="1">Latest Callbacks</th>
