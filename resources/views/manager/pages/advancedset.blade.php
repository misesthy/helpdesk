...
<head>
  ...
  <title>Advanced Setting-Faveo Auto Update Script</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
         ...
         <li class="nav-item has-treeview">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="advancedset.html" class="nav-link active">
                  <i class="nav-icon fas fa-angle-right"></i>
    ...
    <!-- /.sidebar -->
       ...
       <div class="content-wrapper" style="min-height: 728px;">
           <section class="content-header">
               <div class="alert alert-info">
                   <h4>Advanced Settings</h4>
                   <p>Configure advanced software settings, enable and disable individual options.</p>
               </div>
           </section>
           <section class="content">
               <div class="box box-primary">
                   ...
                   <form action="settings_advanced.php" method="post">
                       <div class="box-body">
                           <div class="row">
                               <div class="col-md-6">
                                   <div class="form-group">
                                       <label>PHP Auto Update Script API</label>
                                       <select name="api_status" class="form-control select2 select2-hidden-accessible" data-select2-id="1" tabindex="-1" aria-hidden="true">
                               ...
                               <div class="col-md-6">
                                   <div class="form-group">
                                        <label>Verified Updates Only</label>
                                       <select name="api_verify" class="form-control select2 select2-hidden-accessible" data-select2-id="1" tabindex="-1" aria-hidden="true">
                                           <option value="1">Enabled</option>
                                           <option value="0" selected="" data-select2-id="3">Disabled</option>
                                       </select>
